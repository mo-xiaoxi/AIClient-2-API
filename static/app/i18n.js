...
const translations = {
    'zh-CN': {
        ...
        // Cursor OAuth
        'oauth.cursor.step1': '点击下方按钮在浏览器中打开 Cursor 登录页面',
        'oauth.cursor.step2': '使用您的 Cursor 账号登录（支持 Google/GitHub/邮箱）',
        'oauth.cursor.step3': '登录完成后系统会自动获取凭据（无需手动操作）',
        'oauth.cursor.step4': '凭据文件可在上传配置管理中查看和管理',
        'oauth.cursor.pollingNote': 'Cursor 使用 PKCE 轮询认证，无需开放回调端口',
        'oauth.cursor.selectMethod': '选择操作方式',
        'oauth.cursor.oauth': 'OAuth 登录',
        'oauth.cursor.oauthDesc': '打开 Cursor 登录页面进行 PKCE 授权',
        'oauth.cursor.batchImport': '批量导入 Cursor Token',
        'oauth.cursor.batchImportDesc': '批量导入已有的 Cursor Token JSON 数据',
        'oauth.cursor.tokensLabel': 'Token 数据 (JSON)',
        'oauth.cursor.tokensPlaceholder': '请粘贴包含 access_token 和 refresh_token 的 JSON...',
        'oauth.cursor.importInstructions': '请粘贴 Cursor Token JSON 数据（来自 configs/cursor/ 目录下的 JSON 文件）。支持单个对象或对象数组。',
        'oauth.cursor.noTokens': '请输入有效的 Token 数据',
        'oauth.cursor.importing': '正在导入...',
        'oauth.cursor.importingProgress': '正在处理: {current} / {total}',
        'oauth.cursor.importSuccess': '成功导入 {count} 个 Cursor 凭据',
        'oauth.cursor.importAllFailed': '所有 {count} 个凭据导入失败',
        'oauth.cursor.importPartial': '部分导入成功: {success} 成功, {failed} 失败',
        'oauth.cursor.importError': '导入过程中出错',
        'oauth.cursor.tokenCount': 'Token 数量',
        'oauth.cursor.startImport': '开始导入',
        'oauth.cursor.jsonExample': '查看 JSON 格式示例',
        'oauth.cursor.jsonHint': '请确保 JSON 包含 access_token 和 refresh_token',
        ...
        'upload.providerFilter.cursor': 'Cursor OAuth',
    ...
    'en-US': {
        ...
        // Cursor OAuth
        'oauth.cursor.step1': 'Click the button below to open Cursor login page',
        'oauth.cursor.step2': 'Sign in with your Cursor account (Google/GitHub/Email)',
        'oauth.cursor.step3': 'Credentials will be fetched automatically after login (no manual action needed)',
        'oauth.cursor.step4': 'Credentials can be viewed and managed in Upload Config',
        'oauth.cursor.pollingNote': 'Cursor uses PKCE polling auth — no callback port needed',
        'oauth.cursor.selectMethod': 'Select Method',
        'oauth.cursor.oauth': 'OAuth Login',
        'oauth.cursor.oauthDesc': 'Open Cursor login page for PKCE authorization',
        'oauth.cursor.batchImport': 'Batch Import Cursor Tokens',
        'oauth.cursor.batchImportDesc': 'Import multiple Cursor Token JSON objects',
        'oauth.cursor.tokensLabel': 'Token Data (JSON)',
        'oauth.cursor.tokensPlaceholder': 'Paste JSON containing access_token and refresh_token...',
        'oauth.cursor.importInstructions': 'Paste Cursor Token JSON (from configs/cursor/ directory). Supports single object or array.',
        'oauth.cursor.noTokens': 'Please enter valid Token data',
        'oauth.cursor.importing': 'Importing...',
        'oauth.cursor.importingProgress': 'Processing: {current} / {total}',
        'oauth.cursor.importSuccess': 'Successfully imported {count} Cursor credentials',
        'oauth.cursor.importAllFailed': 'Failed to import all {count} credentials',
        'oauth.cursor.importPartial': 'Partial success: {success} succeeded, {failed} failed',
        'oauth.cursor.importError': 'Import error',
        'oauth.cursor.tokenCount': 'Token Count',
        'oauth.cursor.startImport': 'Start Import',
        'oauth.cursor.jsonExample': 'View JSON Example',
        'oauth.cursor.jsonHint': 'Ensure JSON contains access_token and refresh_token',
